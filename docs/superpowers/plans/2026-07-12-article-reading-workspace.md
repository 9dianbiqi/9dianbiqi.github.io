...
- [x] **Step 3: 实现纯函数并把内容测试加入 npm test**
...
- [x] **Step 1: 先扩展静态验证，要求右栏挂载和三栏 token**
...
- [x] **Step 1: 写入完整 frontmatter 和文章正文**
